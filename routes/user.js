    ...
    Registraion.find({phone:phone, eventid: eventid} ).then(function(result){
    	...
    	else
    	{
			  ...
			  Registraion.create(newRegistraion,function(err,registraion){
				...
				EmailonRegistration(registraion.name,registraion.qrcode,registraion.eventname,registraion.eventid,registraion.email);
				res.send(obj);
				res.end();
			    }
			  });
        ...
        Registraion.findOne({qrcode: req.params.qrcode},function(err, attendeeInfo){
            ...
            Event.findOne({title: ai.eventname},function(err, tst){
                ...
                var html = '<html>'+
                    ...
                    '                                <a href="tel:+91 79884 81668 " style="text-decoration:none;color:#49ba8e" target="_blank">Ph: 79884 81668</a><br><a href="tel:+91 99537 64100 " style="text-decoration:none;color:#49ba8e" target="_blank">Ph: 99537 64100</a>'+
                    '                                '+
                    '                              </td>'+
                    '                            </tr>'+
                    '                          </tbody></table>'+
